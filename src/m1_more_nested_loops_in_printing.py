...
def triangle_right_justified(r):
    ...
    for k in range(r):
        ...
        added = 1
        range2 = r - k - 1
        for j in range(range2 + 1):
            placeholder += ' '
        for i in range(range2, r):
            placeholder += str(added)
            added += 1
        print(placeholder)
...
def numbers_constant_forward(r, maxnum, n):
    ...
    for k in range(r):
        for i in range(maxnum):
            ...
            repeated_num = i + 1
            for j in range(n):
                placeholder = placeholder + str(repeated_num)
